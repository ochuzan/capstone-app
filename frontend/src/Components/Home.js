  ...
  return(
      <div id="chartContainer">
        ...
        <div id="chatbot">
          Chatbot
          <div>
            <img src="https://hybrid.chat/wp-content/uploads/2019/12/auto-hide-text-box.gif" alt="chatbot" />
          </div>
        </div>
        <div id="chart-coins-container">
          <div id="chart-widget">
            ...
            <div id="chart">
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/Pushkin_population_history.svg/1200px-Pushkin_population_history.svg.png" alt="chart" />
            </div>
          </div>
          <div id="top-coins">
